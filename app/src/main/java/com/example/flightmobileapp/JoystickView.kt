...
class JoystickView @JvmOverloads constructor(
    ...
    */
     ...
     * - zero for both axes
     */
    private var buttonDirection: Int = 0
    ...
    val normalizedX: Int
        get() {
            ...
            return ((mPosX - mButtonRadius) * 100.0f / (width - mButtonRadius * 2)).roundToInt()
        }
    ...
    val normalizedY: Int
        get() {
            ...
            return ((mPosY - mButtonRadius) * 100.0f / (height - mButtonRadius * 2)).roundToInt()
        }
    ...
    */
         ...
         */
        private const val DEFAULT_LOOP_INTERVAL: Int = 50 // in milliseconds
